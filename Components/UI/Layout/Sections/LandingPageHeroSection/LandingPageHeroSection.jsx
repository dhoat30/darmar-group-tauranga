      ...
      <div className={`${styles.container}`}>
        <div className={`${styles.contentWrapper} max-width-lg`}>
          ...
          <Container maxWidth="sm" className="flex justify-center" >
            <HeroUSP data={uspData} className="mt-16" centerAlign={true} />
          ...
          {/* <div className={`${styles.reviewWrapper} flex align-center gap-8 flex-wrap justify-center mt-32`}>
            ...
            <div className={`${styles.trustSnippetWrapper} flex gap-8 align-center`}>
              <Image src={trustSnippet.icon.url} alt={trustSnippet.icon.alt} width={34} height={34} />
